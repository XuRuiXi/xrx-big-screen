...
export interface BarGroupChartProps extends Omit<ChartsProps, 'options'> {
  data: ChartData;
  config?: ChartConfig;
}
...
function getChartOptionsByData(data: ChartData, config: ChartConfig = {}): EChartsOption {
  ...
  const {
    ...
    titleSize = 20,
    titleWeight = 500,
    colors = ['#00E5FF', '#512AFB', '#6B7077', '#F1B805'],
    gridTop = 40,
    gridLeft = 10,
    gridRight = 0,
    gridBottom = 10,
...
export function BarGroupChart(props: BarGroupChartProps) {
